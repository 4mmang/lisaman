...
@section('content')
    <div class="flex flex-col flex-1 overflow-hidden">
        ...
        <div class="flex-1 p-6 bg-gray-100 overflow-y-auto">
            <h1 class="text-3xl font-base text-slate-700 mb-4">Edit Product</h1>
                    ...
                    <div class="flex flex-wrap gap-4 lg:flex-nowrap">
                        <div class="w-full lg:w-1/2">
                            <label for="name_product" class="block text-gray-700 text-sm font-bold mb-2">Name
                                Product:</label>
                            <input type="text" autofocus value="{{ $product->name_product }}" id="name_product"
                        ...
                        <div class="w-full lg:w-1/2">
                            ...
                            <input type="number" autofocus value="{{ $product->stok }}" id="stok" name="stok"
                                placeholder=""
                                class="shadow w-full valid:border-green-500 appearance-none border rounded py-2 px-3 text-gray-700 leading-tight">
                        </div>
                        <div class="w-full lg:w-1/2">
                            <label for="price" class="block text-gray-700 text-sm font-bold mb-2">Price:</label>
                            <input type="number" autofocus value="{{ $product->price }}" id="price" name="price"
                                placeholder=""
                                class="shadow w-full valid:border-green-500 appearance-none border rounded py-2 px-3 text-gray-700 leading-tight">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-4 lg:flex-nowrap mt-4 mb-6">
                        <div class="w-full">
                            ...
                            <textarea type="text" cols="5" rows="5" autofocus id="description" name="description" placeholder=""
                                class="shadow w-full valid:border-green-500 appearance-none border rounded py-2 px-3 text-gray-700 leading-tight">{{ $product->description }}</textarea>
                        </div>
                    </div>
