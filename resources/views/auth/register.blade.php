    ...
    <div class="container mx-auto h-screen flex justify-center items-center px-4">
        <div class="bg-white shadow-md rounded-lg max-w-sm w-full p-6">
            ...
            <form action="{{ url('regist') }}" method="post">
                ...
                <button type="submit"
                    class="bg-blue-500 rounded-full text-white px-4 py-2 mt-2 hover:bg-blue-600 w-full">Register</button>
                <div class="flex items-center mt-4">
                    <hr class="flex-grow border-t border-gray-300">
                    <span class="mx-4 text-gray-500">Sudah punya akun? <a href="{{ url('login') }}">Login</a></span>
                    <hr class="flex-grow border-t border-gray-300">
                </div>
